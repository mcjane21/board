  ...
  <div id="content_wrapper" >
    ...
    <div class="container-fluid">
      ...
      <div class="col-xs-12">
        ...
        <h1>Proponents</h1>
        <ol class="breadcrumb">
          <li><a class="active">Proponents</a></li>
        </ol>
        </header>
      </div>
        </div>
    ...
    <div class="content-body">
      ...
      <div class="col-xs-12">
        ...
        <h2 class="card-title">Proponents<center><p id="message" style="color:#ee6e73"></p></center></h2>
        <small class="dataTables_info">Listed below are accounts of all Proponents.</small>
        ...
        <ul class="card-actions icons right-top">
          ...
          <li>
          <a href="listofproponentaccounts.php"  data-toggle="tooltip" data-placement="top" title="Print Proponent Accounts">
            <i class="zmdi zmdi-print"></i>
          </a>
          </li>
          <li>
          <a href=""  data-toggle="modal" data-target="#addProponent" data-placement="top" title="Add Proponent">
