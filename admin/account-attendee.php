  ...
  <div id="content_wrapper" >
    ...
    <div class="container-fluid">
      ...
      <div class="col-xs-12">
        ...
        <h1>Accounts</h1>
        <ol class="breadcrumb">
          <li><a class="active">Attendee</a></li>
        </ol>
        </header>
      </div>
      </div>
    ...
    <div class="content-body">
      ...
      <div class="col-xs-12">
        ...
        <header class="card-heading">
          <h2 class="card-title">Attendees<center><p id="message" style="color:#ee6e73"></p></center></h2>
          <small class="dataTables_info">Listed below are accounts of all the meeting attendees.</small>
          ...
          <li>
            <a href="listofattendeeaccounts.php"  data-toggle="tooltip" data-placement="top" title="Print Attendee Accounts">
            <i class="zmdi zmdi-print"></i>
            </a>
          </li>
          <li>
            <a href=""  data-toggle="modal" data-target="#addAttendee" data-placement="top" title="Add Attendee">
