												  	...
												  	<li class="list-group-item">
														<div class="list-group-item-body" >
															<div class="list-group-item-heading" ><a>New...</a></div>
																<div class="list-group-item-text" style="text-align:left;padding-left:15%;padding-right:15%"><a href="" 		data-toggle="	modal" data-target="#boardResolution" value="">BOR Resolution  Series of </a></div>
															<!--View Resolution modal-->		
															<div class="modal fade" id="boardResolution" tabindex="-1" role="dialog" aria-labelledby="basic_modal">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	<div class="modal-header">
																		<h4 class="modal-title" id="myModalLabel-2">Resolution No.  Series of </h4>
