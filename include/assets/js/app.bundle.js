...
/***/ (function(module, exports) {
	...
	var sweetAlerts = function sweetAlerts() {
		...
		$('#sweet_alerts_card').on('click.sweet-error', '.sweet-errorlogin', function (e) {
			e.stopPropagation();
		...
		$('#sweet_alerts_card').on('click.sweet-success', '.sweet-successlogin', function (e) {
			e.stopPropagation();
			swal("Welcome!", "You've successfully logged in!", "success");
